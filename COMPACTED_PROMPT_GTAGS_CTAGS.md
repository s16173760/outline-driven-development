...
| 13 | gtags | Cross-reference database (defs/refs) |
| 14 | ctags | Tag file generator, 200+ languages |

**Selection Guide:**
- Discovery → fd | Code pattern → ast-grep | Simple edit → srgn
- Multi-file atomic → Edit suite | Text/comments → rg | Symbol nav → global/ctags | Scope → tokei | VCS → git-branchless
